...
#define STRING_CONFIG_H_AUTHOR "@apevec @ozi.pevec" // Who made the changes.
#define SHOW_BOOTSCREEN
#define STRING_SPLASH_LINE1 SHORT_BUILD_VERSION // will be shown during bootup in line 1
#define STRING_SPLASH_LINE2 "ANYCUBIC AH10"         // will be shown during bootup in line 2
...
#define CUSTOM_MACHINE_NAME "Oz's Kossel"
...
#define DELTA
  ...
  // NOTE NB all values for DELTA_* values MUST be floating point, so always have a decimal point in them
    ...
    #define DELTA_DIAGONAL_ROD 268.33 // mm
